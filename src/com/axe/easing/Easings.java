...
public class Easings
{
	...
	public static final EasingType In = new AbstractEasingType( "In" ) {
		public float delta(float d, EasingMethod f) {
			return f.motion(d);
		}
	};
	public static final EasingType Out = new AbstractEasingType( "Out" ) {
		public float delta(float d, EasingMethod f) {
			return (1 - f.motion(1 - d));
		}
	};
	public static final EasingType InOut = new AbstractEasingType( "InOut" ) {
		public float delta(float d, EasingMethod f) {
			if (d < 0.5)
	...
	public static final EasingType PingPong = new AbstractEasingType( "PingPong" ) {
		public float delta(float d, EasingMethod f) {
			if (d < 0.5)
				return f.motion(2 * d);
	...
	public static final EasingMethod Linear = new AbstractEasingMethod( "Linear" ) {
	...
	public static EasingType[] Types = Reflections.getStaticFieldArray( EasingType.class, true, Easings.class );
	
	public static Map<String, EasingType> TypeMap = Reflections.getStaticFieldMap( EasingType.class, true, Easings.class, new LinkedHashMap<String, EasingType>() );
	
	public static EasingMethod[] Methods = Reflections.getStaticFieldArray( EasingMethod.class, true, Easings.class );

	public static Map<String, EasingMethod> MethodMap = Reflections.getStaticFieldMap( EasingMethod.class, true, Easings.class, new LinkedHashMap<String, EasingMethod>() );
